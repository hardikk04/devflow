...
const RightSidebar = () => {
  ...
  const PopularTags = [
    { _id: 1, title: "REACT.JS", totalQuestion: 1 },
    { _id: 2, title: "REACT.JS", totalQuestion: 2 },
    { _id: 3, title: "REACT.JS", totalQuestion: 5 },
  ];
  return (
    <section className="border-l h-screen sticky right-0 top-0 w-[360px] flex flex-col overflow-y-auto text-white border-gray-600   max-xl:hidden bg-gray-900 p-6 pt-36">
      ...
      <div className="mt-16">
        ...
        <div className="flex flex-col gap-5">
          {PopularTags.map((tag) => {
            return <PopularTag key={tag._id} tag={tag}></PopularTag>;
          })}
        </div>
      </div>
    </section>
